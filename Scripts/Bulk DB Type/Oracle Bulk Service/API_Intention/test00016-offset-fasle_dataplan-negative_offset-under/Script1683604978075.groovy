...
response = WS.sendRequest(findTestObject('bulk_master_api/oracle/oracel_Api_int', [('ServiceName') : GlobalVariable.oracal_api_int_rest[
            0], ('BulkID') : GlobalVariable.oracal_api_int_rest[1], ('StopLimit') : 100, ('OffsetEnable') : false]))
...
WS.verifyElementPropertyValue(response123, GlobalVariable.oracal_index[2], 100, FailureHandling.STOP_ON_FAILURE)
...
responseAPI = WS.sendRequest(findTestObject('Oracel_Api_intmention_withoffset', [('id') : -7]))
