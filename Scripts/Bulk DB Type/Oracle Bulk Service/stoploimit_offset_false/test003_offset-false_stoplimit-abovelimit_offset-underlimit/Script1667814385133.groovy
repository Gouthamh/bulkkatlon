...
response = WS.sendRequest(findTestObject('bulk_master_api/oracle/update_api_orcale', [('OffsetEnable') : GlobalVariable.Offset_false
            , ('StopLimit') : GlobalVariable.offsetisabovelimit, ('ServiceName') : GlobalVariable.Oracle_BulkProcess, ('BulkID') : GlobalVariable.Oracle_bulkID]))
...
WS.verifyElementPropertyValue(response1, '[11].oracleDbParameters.StopLimit', GlobalVariable.offsetisabovelimit)

WS.verifyElementPropertyValue(response1, '[11].oracleDbParameters.OffsetEnable', GlobalVariable.Offset_false)
...
WS.sendRequestAndVerify(findTestObject('TriggerBulkAPI_DB_Bulk', [('bulkProcessName') : GlobalVariable.Oracle_BulkProcess
	, ('URL') : GlobalVariable.URL, ('stoplimitunderlimit') : GlobalVariable.stoplimitunderlimit]))
