...
response = WS.sendRequest(findTestObject('bulk_master_api/Mysql/form_data', [('URL') : GlobalVariable.URL, ('ServiceName') : GlobalVariable.MySql_BulkProcess
            , ('BulkID') : GlobalVariable.MySql_BulkID, ('ServiceName') : GlobalVariable.MySql_BulkProcess, ('OffsetEnable') : true
...
WS.verifyElementPropertyValue(response1, GlobalVariable.MysqlDBFormdataOffset, true)
