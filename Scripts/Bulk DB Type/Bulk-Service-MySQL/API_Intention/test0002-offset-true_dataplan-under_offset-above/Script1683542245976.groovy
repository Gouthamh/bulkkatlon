...
response = WS.sendRequest(findTestObject('bulk_master_api/Mysql/apimusql', [('ServiceName') : GlobalVariable.Mysql_Api_Intemtion[
            0], ('BulkID') : GlobalVariable.Mysql_Api_Intemtion[1], ('StopLimit') : 1001, ('OffsetEnable') : true]))
...
WS.verifyElementPropertyValue(response123, GlobalVariable.MySql_Api_intemtion_index[4], 1001, FailureHandling.STOP_ON_FAILURE)
