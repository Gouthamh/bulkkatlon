...
response = WS.sendRequest(findTestObject('bulk_master_api/Mysql/apimusql', [('ServiceName') : GlobalVariable.Mysql_Api_Intemtion[
            0], ('BulkID') : GlobalVariable.Mysql_Api_Intemtion[1], ('StopLimit') : 50, ('OffsetEnable') : true]))
...
WS.verifyElementPropertyValue(response123, GlobalVariable.MySql_Api_intemtion_index[5], true, FailureHandling.STOP_ON_FAILURE)
