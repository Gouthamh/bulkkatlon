...
response = WS.sendRequestAndVerify(findTestObject('bulk_master_api/Mysql/mysql_update_bulk_services', [('URL') : GlobalVariable.URL, ('UpdateBulkMasterConfig') : GlobalVariable.UpdateBulkMasterConfig
            , ('Offset_true') : GlobalVariable.Offset_true, ('dummiservicename') : GlobalVariable.MySql_BulkProcess, ('dummiid') : GlobalVariable.MySql_BulkID
...
//
WS.verifyEqual(countEntries4, countEntries5-GlobalVariable.stoplimitunderlimit)  //78
//
////
...
//
WS.verifyEqual(countEntries5, countEntries6-GlobalVariable.stoplimitunderlimit)  //910
//
//
