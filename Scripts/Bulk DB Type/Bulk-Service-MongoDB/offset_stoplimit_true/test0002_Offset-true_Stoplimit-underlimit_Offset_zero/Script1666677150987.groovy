...
response = WS.sendRequestAndVerify(findTestObject('bulk_master_api/mongoDB/update_Api_for_mongo_bulk_type', [('URL') : GlobalVariable.URL, ('UpdateBulkMasterConfig') : GlobalVariable.UpdateBulkMasterConfig
            , ('ServiceName') : GlobalVariable.Mongo_BulkProcess, ('ServiceId') : GlobalVariable.Mongo_BulkID, ('StopLimit') : GlobalVariable.stoplimitunderlimit
            , ('OffSet') : GlobalVariable.Offset_true]))
...
WS.verifyElementPropertyValue(response1, GlobalVariable.MongoDBOffsetIndex, GlobalVariable.Offset_true)
...
response2 = WS.sendRequestAndVerify(findTestObject('TriggerBulkAPI_DB_Bulk', [('URL') : GlobalVariable.URL, ('bulkProcessName') : GlobalVariable.Mongo_BulkProcess
            , ('stoplimitunderlimit') : GlobalVariable.offsetiszero])) //1st
...
WS.verifyEqual(countEntries1, countEntries2 - GlobalVariable.stoplimitunderlimit)
  ...
  :GlobalVariable.URL,('bulkProcessName'):GlobalVariable.Mongo_BulkProcess]))//3nd
  ...
  WS.verifyEqual(countEntries2, countEntries3 -
  GlobalVariable.stoplimitunderlimit+1)
  
	/*
	 * WS.sendRequestAndVerify(findTestObject('TriggerBulkAPIWithJsonEmpty',[('URL')
	 * :GlobalVariable.URL,('bulkProcessName'):GlobalVariable.Mongo_BulkProcess]))//
	 * 4nd
	 * 
	 * countEntries4 =
	 * CustomKeywords.'mongoDatabaseOperations.MongoConnect.countDBEntries'(
	 ...
	 * 
	 * WS.verifyEqual(countEntries3, countEntries4 -
	 * GlobalVariable.stoplimitunderlimit)
	 * 
	 * WS.sendRequestAndVerify(findTestObject('TriggerBulkAPIWithJsonEmpty',[('URL')
	 * :GlobalVariable.URL,('bulkProcessName'):GlobalVariable.Mongo_BulkProcess]))//
	 * 5nd
	 ...
	 * 
	 * WS.verifyEqual(countEntries4, countEntries5 -
	 * GlobalVariable.stoplimitunderlimit)
	 */