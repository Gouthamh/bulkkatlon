...
response2=WS.sendRequestAndVerify(findTestObject('TriggerBulkAPI_DB_Bulk',[('URL'):GlobalVariable.URL,('bulkProcessName'):GlobalVariable.Mongo_BulkProcess,('stoplimitunderlimit'):GlobalVariable.offsetiszero]))
