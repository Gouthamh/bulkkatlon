...
/*
 * WS.sendRequestAndVerify(findTestObject('TriggerBulkAPIWithJsonEmpty',
 * [('URL') : GlobalVariable.URL, ('bulkProcessName') :
 * GlobalVariable.Mongo_BulkProcess] //3nd ))
 * 
 * WS.delay(10)
 * 
 * countEntries3 =
 ...
 * WS.sendRequestAndVerify(findTestObject('TriggerBulkAPIWithJsonEmpty',
 * [('URL') : GlobalVariable.URL, ('bulkProcessName') :
 * GlobalVariable.Mongo_BulkProcess] //4nd ))
 * 
 * WS.delay(10)
 * 
 * countEntries4 =
