...
response = WS.sendRequest(findTestObject('bulk_master_api/Cassandra-db/rest_updataApi', [('ServiceName') : GlobalVariable.cassandravalue[
            0], ('BulkID') : GlobalVariable.cassandravalue[1], ('CqlQuery') : GlobalVariable.cassandravalue[7], ('Notify') : false]))
...
response2 = WS.sendRequestAndVerify(findTestObject('Cassandra_triggerapi', [('bulkProcessName') : GlobalVariable.cassandravalue[0], ('URL') : GlobalVariable.URL]))
