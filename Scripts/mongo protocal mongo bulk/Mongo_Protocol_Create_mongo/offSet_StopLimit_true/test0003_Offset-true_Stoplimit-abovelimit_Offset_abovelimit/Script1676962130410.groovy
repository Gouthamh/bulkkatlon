...
response = WS.sendRequest(findTestObject('bulk_master_api/mongo_mongo/mongoprotocalcreate', [('ServiceName') : 'db-mongo-create-mongo'
            , ('BulkID') : 108, ('StopLimit') : GlobalVariable.offsetisabovelimit, ('OffsetEnable') : GlobalVariable.Offset_true]))
...
WS.verifyElementPropertyValue(response1,GlobalVariable.CreateMongoIndexStopLimit, GlobalVariable.offsetisabovelimit)

WS.verifyElementPropertyValue(response1, GlobalVariable.CreateMongoIndexOffset, GlobalVariable.Offset_true)
////////////////////
...
WS.verifyEqual(IntialDB, FinalDB+IntialDB)
...
///////////// 3
initial1 = CustomKeywords.'mongoDatabaseOperations.MongoConnect.fetchFile1234'(GlobalVariable.Mongo_URL, GlobalVariable.MongoDBName, 
    GlobalVariable.Mongo_BulkService_ReqCollection, 'msisdn', '2')

System.out.println('initial1__' + initial1)

final1 = CustomKeywords.'mongoDatabaseOperations.MongoConnect.fetchFile1234'(GlobalVariable.Mongo_URL, GlobalVariable.MongoDBName, 
    'DAP_BULK_MONGO_PROTOCOL_OPERATIONS_MONGO', 'msisdn', '2')
...
WS.verifyEqual(initial1, final1-initial1)
