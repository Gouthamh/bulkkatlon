...
WS.sendRequestAndVerify(findTestObject('Mongo_protocol_create', [('URL') : GlobalVariable.URL, ('bulkProcessName') : GlobalVariable.Mongo_create]))
...
countEntries2 = CustomKeywords.'mongoDatabaseOperations.MongoConnect.countDBEntries'(GlobalVariable.Mongo_URL, GlobalVariable.MongoDBName, 
    'DAP_BULK_MONGO_PROTOCOL_OPERATIONS_MONGO')
WS.delay(20)
System.out.println("Requests__"+Requests)
