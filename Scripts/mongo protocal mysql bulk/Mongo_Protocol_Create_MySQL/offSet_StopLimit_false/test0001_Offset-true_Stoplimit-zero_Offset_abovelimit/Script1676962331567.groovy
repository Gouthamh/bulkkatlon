...
response = WS.sendRequest(findTestObject('bulk_master_api/mongomysql/create', [('ServiceName') : GlobalVariable.createmysql
            , ('BulkID') : GlobalVariable.Create_mysql_id, ('StopLimit') : GlobalVariable.offsetiszero, ('OffsetEnable') : GlobalVariable.Offset_false]))
...
WS.verifyElementPropertyValue(response1, GlobalVariable.CreateMysqlIndexStopLimit, GlobalVariable.offsetiszero)
...
println('Frommysql' + InitialEntries)

WS.verifyEqual(count1, InitialEntries)
