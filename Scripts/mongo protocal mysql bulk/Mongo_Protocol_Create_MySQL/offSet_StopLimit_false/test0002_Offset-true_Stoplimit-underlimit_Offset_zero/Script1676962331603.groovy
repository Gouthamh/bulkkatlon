...
response=WS.sendRequest(findTestObject('bulk_master_api/mongomysql/create', [('ServiceName') : GlobalVariable.createmysql
	, ('BulkID') : GlobalVariable.Create_mysql_id, ('StopLimit') : GlobalVariable.stoplimitunderlimit, ('OffsetEnable') : GlobalVariable.Offset_false]))
...
WS.verifyElementPropertyValue(response1, GlobalVariable.CreateMysqlIndexStopLimit, GlobalVariable.stoplimitunderlimit)

WS.verifyElementPropertyValue(response1, GlobalVariable.CreateMysqlIndexOffset, GlobalVariable.Offset_false)
...
WS.verifyEqual(count1+InitialEntries-GlobalVariable.stoplimitunderlimit, InitialEntries)
...
WS.sendRequest(findTestObject('Mongo_protocol_create - Copy',[('URL') : GlobalVariable.URL, ('Mongo_create') : GlobalVariable.createmysql
]))
...
WS.verifyEqual(InitialEntries, 7)*/