...
response = WS.sendRequest(findTestObject('bulk_master_api/mongomysql/delete', [('ServiceName') : GlobalVariable.deleteMysql
			, ('BulkID') : GlobalVariable.deletemysqlid, ('StopLimit') : GlobalVariable.offsetisabovelimit, ('OffsetEnable') : GlobalVariable.Offset_true]))
...
WS.verifyElementPropertyValue(response1, GlobalVariable.DeleteMysqlIndexStopLimit, GlobalVariable.offsetisabovelimit)
