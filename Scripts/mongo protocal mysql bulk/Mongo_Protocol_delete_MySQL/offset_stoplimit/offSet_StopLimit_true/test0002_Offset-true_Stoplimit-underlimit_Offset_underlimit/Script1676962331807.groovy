...
response = WS.sendRequest(findTestObject('bulk_master_api/mongomysql/delete', [('ServiceName') : GlobalVariable.deleteMysql
            , ('BulkID') : GlobalVariable.deletemysqlid, ('StopLimit') : GlobalVariable.stoplimitunderlimit, ('OffsetEnable') : GlobalVariable.Offset_true]))
...
WS.verifyElementPropertyValue(response1, GlobalVariable.DeleteMysqlIndexOddSet, GlobalVariable.Offset_true)

WS.verifyElementPropertyValue(response1, GlobalVariable.DeleteMysqlIndexStopLimit, GlobalVariable.stoplimitunderlimit)
...
WS.sendRequest(findTestObject('Mongo_protocol_create - Copy',[('URL') : GlobalVariable.URL, ('Mongo_create') : GlobalVariable.deleteMysql
]))
