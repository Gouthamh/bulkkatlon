...
response = WS.sendRequest(findTestObject('bulk_master_api/mongomysql/update', [('ServiceName') : GlobalVariable.updatemysql
            , ('BulkID') : GlobalVariable.updatemysqlid, ('StopLimit') : GlobalVariable.offsetiszero, ('OffsetEnable') : GlobalVariable.Offset_false]))
...
////////////////////////
WS.sendRequestAndVerify(findTestObject('Mongo_protocol_create', [('URL') : GlobalVariable.URL, ('Mongo_create') : GlobalVariable.updatemysql
