...
response = WS.sendRequest(findTestObject('bulk_master_api/mongomysql/update', [('ServiceName') : GlobalVariable.updatemysql
			, ('BulkID') : GlobalVariable.updatemysqlid, ('StopLimit') : GlobalVariable.stoplimitunderlimit, ('OffsetEnable') : GlobalVariable.Offset_false]))
...
WS.verifyElementPropertyValue(response1, GlobalVariable.UpdateMysqlIndexOffset, GlobalVariable.Offset_false)

WS.verifyElementPropertyValue(response1, GlobalVariable.UpdateMysqlIndexStopLimit, GlobalVariable.stoplimitunderlimit)
////////////////////////////////
...
WS.verifyNotEqual(initial12, final12)

WS.verifyEqual(final12, 'Goutham 1')
...
WS.verifyNotEqual(initial21, final21)

WS.verifyEqual(final21, 'Goutham 2')
final1 = CustomKeywords.'mongoDatabaseOperations.MongoConnect.fetchFile1234'(GlobalVariable.Mongo_URL, GlobalVariable.MongoDBName,
	'DAP_BULK_MONGO_PROTOCOL_OPERATIONS_MYSQL', '$.inputValue.id', '1')
...
/////////////////////////////////////////////////////////////////////////////////////////////
WS.sendRequest(findTestObject('Mongo_protocol_create - Copy',[('URL') : GlobalVariable.URL, ('Mongo_create') : GlobalVariable.updatemysql
]))
...
WS.verifyNotEqual(initial32, final32)

WS.verifyEqual(final32, 'Goutham 3')
...
WS.verifyNotEqual(initial42, final42)

WS.verifyEqual(final42, 'Goutham 4')
...
final52 = CustomKeywords.'mongoDatabaseOperations.MongoConnect.fetchFile1234'(GlobalVariable.Mongo_URL, GlobalVariable.MongoDBName,
	'DAP_BULK_MONGO_PROTOCOL_OPERATIONS_MYSQL', '$.inputValue.NAME', 'Goutham 5')

WS.verifyNotEqual(initial52, final52)

WS.verifyEqual(final52, 'Goutham 5')
...
WS.verifyNotEqual(initial62, final62)

WS.verifyEqual(final62, 'Goutham 6')
...
WS.verifyNotEqual(initial72, final72)

WS.verifyEqual(final72, 'Goutham 7')