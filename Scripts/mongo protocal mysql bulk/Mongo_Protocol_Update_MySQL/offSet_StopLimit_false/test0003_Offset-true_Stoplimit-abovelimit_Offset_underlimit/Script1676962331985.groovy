...
response = WS.sendRequest(findTestObject('bulk_master_api/mongomysql/update', [('ServiceName') : GlobalVariable.updatemysql
            , ('BulkID') : GlobalVariable.updatemysqlid, ('StopLimit') : GlobalVariable.offsetisabovelimit, ('OffsetEnable') : GlobalVariable.Offset_false]))
...
WS.verifyElementPropertyValue(response1, GlobalVariable.UpdateMysqlIndexStopLimit, GlobalVariable.offsetisabovelimit)
////////////////////////////////
