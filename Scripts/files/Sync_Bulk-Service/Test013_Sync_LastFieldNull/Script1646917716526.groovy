...
fileName = WS.concatenate((([GlobalVariable.FullQualifiedFilePath, 'Test9_Sync_LastFieldNull.csv']) as String[]))
...
filePath = WS.concatenate((([GlobalVariable.Data_Files, 'Test9_Sync_LastFieldNull.csv']) as String[]))
