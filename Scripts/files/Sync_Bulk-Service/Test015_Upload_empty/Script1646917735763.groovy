...
fileName = WS.concatenate((([GlobalVariable.FullQualifiedFilePath, 'Test11_POSTBlank_File.csv']) as String[]))
...
fileSend = WS.concatenate((([GlobalVariable.Data_Files, 'Test11_POSTBlank_File.csv']) as String[]))
