...
fileSend = WS.concatenate((([GlobalVariable.Data_Files, GlobalVariable.Sync_FileName]) as String[]))

output = WS.sendRequestAndVerify(findTestObject('FileUpload', [('path') : fileSend, ('bulkProcessName') : GlobalVariable.Sync_BulkProcess
...
output2 = WS.sendRequestAndVerify(findTestObject('FileUpload', [('path') : fileSend, ('bulkProcessName') : GlobalVariable.Sync_BulkProcess
            , ('bulkId') : GlobalVariable.Sync_BulkID, ('URL') : GlobalVariable.URL]))
