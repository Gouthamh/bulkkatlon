...
uploadresponse = WS.sendRequestAndVerify(findTestObject('FileUpload', [('path') : 'files/MandatoryFields-MixedFiles-0.csv'
...
WS.verifyElementPropertyValue(uploadresponse, 'uploadDetails[0].FileName[0]', 'MandatoryFields-MixedFiles-0.csv')
...
CustomKeywords.'mongoDatabaseOperations.MongoConnect.DeleteDBManyRecords'(GlobalVariable.Mongo_URL, GlobalVariable.MongoDBName, 
    'BULK_DATA_FILE_INFO', 'fileName', 'files/MandatoryFields-MixedFiles-0.csv')
