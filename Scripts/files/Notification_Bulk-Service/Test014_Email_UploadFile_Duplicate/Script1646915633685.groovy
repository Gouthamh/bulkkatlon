...
fileName = WS.concatenate((([GlobalVariable.FullQualifiedFilePath, GlobalVariable.Notification_FileName]) as String[]))
...
fileSend = WS.concatenate((([GlobalVariable.Data_Files, GlobalVariable.Notification_FileName]) as String[]))

output = WS.sendRequestAndVerify(findTestObject('FileUpload', [('path') : fileSend, ('bulkProcessName') : GlobalVariable.Notification_BulkProcess
...
output2 = WS.sendRequestAndVerify(findTestObject('FileUpload', [('path') : fileSend, ('bulkProcessName') : GlobalVariable.Notification_BulkProcess
            , ('bulkId') : GlobalVariable.Notification_BulkID, ('URL') : GlobalVariable.URL]))
WS.verifyElementPropertyValue(output2, 'uploadDetails[0].msg', 'File already present in specified path')
