...
fileName = WS.concatenate((([GlobalVariable.FullQualifiedFilePath, 'Test10_SMS_ErrorEntries.csv']) as String[]))
...
filePath = WS.concatenate((([GlobalVariable.Data_Files, 'Test10_SMS_ErrorEntries.csv']) as String[]))
