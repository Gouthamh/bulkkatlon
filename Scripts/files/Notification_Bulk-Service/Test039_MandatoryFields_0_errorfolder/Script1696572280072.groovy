...
response = WS.sendRequest(findTestObject('bulk_master_api/file/notification-bulk-service', [('ServiceName') : GlobalVariable.Notification_BulkProcess
            , ('BulkID') : GlobalVariable.Notification_BulkID, ('MandatoryFields') : '0',('SkipRowCount') : 0,('CompressFiles') : false]))
...
uploadresponse = WS.sendRequestAndVerify(findTestObject('FileUpload', [('path') : 'files/MandatoryFields-errorfolder-0.csv'
...
WS.verifyElementPropertyValue(uploadresponse, 'uploadDetails[0].FileName[0]', 'MandatoryFields-errorfolder-0.csv')
...
CustomKeywords.'mongoDatabaseOperations.MongoConnect.DeleteDBManyRecords'(GlobalVariable.Mongo_URL, GlobalVariable.MongoDBName, 
    'BULK_DATA_FILE_INFO', 'fileName', 'files/MandatoryFields-errorfolder-0.csv')
