...
fileName = WS.concatenate((([GlobalVariable.FullQualifiedFilePath, 'Test17_notificationEmail_NullEntries_InFile.csv']) as String[]))
...
filePath = WS.concatenate((([GlobalVariable.Data_Files, 'Test17_notificationEmail_NullEntries_InFile.csv']) as String[]))
