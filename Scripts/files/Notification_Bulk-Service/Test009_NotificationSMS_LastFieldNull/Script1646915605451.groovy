...
fileName = WS.concatenate((([GlobalVariable.FullQualifiedFilePath, 'Test9_NotificationSMS_LastFieldNull.csv']) as String[]))
...
filePath = WS.concatenate((([GlobalVariable.Data_Files, 'Test9_NotificationSMS_LastFieldNull.csv']) as String[]))
