...
fileName = WS.concatenate((([GlobalVariable.FullQualifiedFilePath, 'Test18_NotificationEmail_FirstFieldNull.csv']) as String[]))
...
filePath = WS.concatenate((([GlobalVariable.Data_Files, 'Test18_NotificationEmail_FirstFieldNull.csv']) as String[]))
