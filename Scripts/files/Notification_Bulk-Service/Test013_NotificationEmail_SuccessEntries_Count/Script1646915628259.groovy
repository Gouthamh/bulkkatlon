...
fileName = WS.concatenate((([GlobalVariable.FullQualifiedFilePath, 'Test13_NotificationEmail_SuccessEntries_Count.csv']) as String[]))
...
filePath = WS.concatenate((([GlobalVariable.Data_Files, 'Test13_NotificationEmail_SuccessEntries_Count.csv']) as String[]))
