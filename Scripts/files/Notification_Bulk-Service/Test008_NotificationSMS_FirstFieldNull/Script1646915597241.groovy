...
fileName = WS.concatenate((([GlobalVariable.FullQualifiedFilePath, 'Test8_NotificationSMS_FirstFieldNull.csv']) as String[]))
...
countEntries = CustomKeywords.'mongoDatabaseOperations.MongoConnect.countDBEntries'(GlobalVariable.Mongo_URL,
	GlobalVariable.MongoDBName, 'NOTIFICATION_SMS_HISTORY')

filePath = WS.concatenate((([GlobalVariable.Data_Files, 'Test8_NotificationSMS_FirstFieldNull.csv']) as String[]))
