...
cont = WS.concatenate(((['Katalon,', 'Automation']) as String[]))

System.out.println('cont_____' + cont)

fileName = WS.concatenate((([GlobalVariable.FullQualifiedFilePath, 'Test7_Notification_NullEntries_InFile.csv']) as String[]))

fileName = WS.concatenate((([GlobalVariable.FullQualifiedFilePath, 'Test7_Notification_NullEntries_InFile.csv,', GlobalVariable.FullQualifiedFilePath
            , 'Test7_Notification_NullEntries_InFile.csv']) as String[]))

System.out.println('fileName_________' + fileName)
...
filePath = WS.concatenate((([GlobalVariable.Data_Files, 'Test7_Notification_NullEntries_InFile.csv,',GlobalVariable.Data_Files, 'Test7_Notification_NullEntries_InFile.csv']) as String[]))


System.out.println('filePath____' + filePath)
...
WS.sendRequestAndVerify(findTestObject('FileUpload', [('path') : filePath, ('bulkProcessName') : GlobalVariable.Notification_BulkProcess
			 ...
			 * : GlobalVariable.Notification_BulkProcess, ('URL') : GlobalVariable.URL]))
			 * 
			 * countFiles2 =
			 ...
			 * 
			 * WS.verifyEqual(countEntries, countEntries2 - 8)
			 */