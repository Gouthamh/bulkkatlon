...
fileName = WS.concatenate((([GlobalVariable.FullQualifiedFilePath, 'Test19_NotificationEmail_LastFieldNull.csv']) as String[]))
...
filePath = WS.concatenate((([GlobalVariable.Data_Files, 'Test19_NotificationEmail_LastFieldNull.csv']) as String[]))
...
WS.verifyEqual(countEntries, countEntries2 - 2)