...
response = WS.sendRequest(findTestObject('bulk_master_api/file/notification-bulk-service', [('ServiceName') : GlobalVariable.Notification_BulkProcess
			, ('BulkID') : GlobalVariable.Notification_BulkID, ('MandatoryFields') : '', ('SkipRowCount') : 0, ('CompressFiles') : true]))
...
CustomKeywords.'sftp_keyword.refactor_sftp.countFiles'(GlobalVariable.Sftp_inform[0], GlobalVariable.Sftp_inform[1], GlobalVariable.Sftp_inform[
	2], GlobalVariable.Notification_bulks_services_host, GlobalVariable.Sftp_inform[3], '/bulk-store/ProccessedFiles')
...
nale = CustomKeywords.'sftp_keyword.refactor_sftp.SFTPFileExtensionValidator'(GlobalVariable.Sftp_inform[0], GlobalVariable.Sftp_inform[
	1], GlobalVariable.Sftp_inform[2], GlobalVariable.Notification_bulks_services_host, GlobalVariable.Sftp_inform[3], '/bulk-store/ProccessedFiles/','[.gz]')


WS.verifyEqual(nale, true)
