...
fileName = WS.concatenate((([GlobalVariable.FullQualifiedFilePath, 'Test20_Email_ErrorEntries.csv']) as String[]))
...
filePath = WS.concatenate((([GlobalVariable.Data_Files, 'Test20_Email_ErrorEntries.csv']) as String[]))
