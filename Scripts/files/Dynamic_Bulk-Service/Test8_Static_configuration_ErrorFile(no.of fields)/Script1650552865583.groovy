...
fileName = WS.concatenate((([GlobalVariable.FullQualifiedFilePath, 'test1_Dynamic_Bulk_6fields.csv']) as String[]))
...
fileSend = WS.concatenate((([GlobalVariable.Data_Files, 'test1_Dynamic_Bulk_6fields.csv']) as String[]))
