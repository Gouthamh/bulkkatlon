...
fileSend = WS.concatenate((([GlobalVariable.Data_Files, GlobalVariable.Dynamic_FileName]) as String[]))
...
WS.sendRequestAndVerify(findTestObject('Dynamic_Bulk_Service/IsHeaderPresent(true)', [('bulkProcessName') : GlobalVariable.Dynamic_BulkProcess, ('URL') : GlobalVariable.URL]))
