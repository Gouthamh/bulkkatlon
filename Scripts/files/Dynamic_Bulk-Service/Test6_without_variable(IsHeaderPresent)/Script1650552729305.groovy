...
WS.sendRequestAndVerify(findTestObject('Dynamic_Bulk_Service/Without_Variable(IsHeaderPresent)', [('bulkProcessName') : GlobalVariable.Dynamic_BulkProcess, ('URL') : GlobalVariable.URL]))
