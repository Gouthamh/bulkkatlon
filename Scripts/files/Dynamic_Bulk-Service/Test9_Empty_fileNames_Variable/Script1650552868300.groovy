...
WS.sendRequestAndVerify(findTestObject('Dynamic_Bulk_Service/Empty_fileNames_Variable', [('bulkProcessName') : GlobalVariable.Dynamic_BulkProcess, ('URL') : GlobalVariable.URL]))
...
output = WS.sendRequestAndVerify(findTestObject('Dynamic_Bulk_Service/triggerDynamicBulkAPI', [('bulkProcessName') : GlobalVariable.Dynamic_BulkProcess, ('URL') : GlobalVariable.URL]))
