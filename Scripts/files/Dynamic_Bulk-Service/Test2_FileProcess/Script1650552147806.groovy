...
WS.sendRequestAndVerify(findTestObject('Dynamic_Bulk_Service/Dynamic_Count_Success_Test2', [('bulkProcessName') : GlobalVariable.Dynamic_BulkProcess, ('URL') : GlobalVariable.URL]))
