...
fileName = WS.concatenate((([GlobalVariable.FullQualifiedFilePath, 'GroupID_bulk1.csv']) as String[]))
...
filePath = WS.concatenate((([GlobalVariable.Data_Files, 'GroupID_bulk1.csv']) as String[]))
