...
fileName = WS.concatenate((([GlobalVariable.FullQualifiedFilePath, 'Test8_GroupId_ErrorEntries.csv']) as String[]))
...
filePath = WS.concatenate((([GlobalVariable.Data_Files, 'Test8_GroupId_ErrorEntries.csv']) as String[]))
