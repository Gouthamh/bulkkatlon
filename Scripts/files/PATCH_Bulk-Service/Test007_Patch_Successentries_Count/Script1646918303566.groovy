...
fileName = WS.concatenate((([GlobalVariable.FullQualifiedFilePath, 'Test3_Patch_Successentries_Count.csv']) as String[]))
...
filePath = WS.concatenate((([GlobalVariable.Data_Files, 'Test3_Patch_Successentries_Count.csv']) as String[]))
