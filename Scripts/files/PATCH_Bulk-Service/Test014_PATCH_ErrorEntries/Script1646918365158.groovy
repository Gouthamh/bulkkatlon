...
fileName = WS.concatenate((([GlobalVariable.FullQualifiedFilePath, 'Test10_PATCH_ErrorEntries.csv']) as String[]))
...
filePath = WS.concatenate((([GlobalVariable.Data_Files, 'Test10_PATCH_ErrorEntries.csv']) as String[]))
