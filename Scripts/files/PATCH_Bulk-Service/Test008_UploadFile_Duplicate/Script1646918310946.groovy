...
fileSend = WS.concatenate((([GlobalVariable.Data_Files, GlobalVariable.PATCH_FileName]) as String[]))

output = WS.sendRequestAndVerify(findTestObject('FileUpload', [('path') : fileSend, ('bulkProcessName') : GlobalVariable.PATCH_BulkProcess
...
output2 = WS.sendRequestAndVerify(findTestObject('FileUpload', [('path') : fileSend, ('bulkProcessName') : GlobalVariable.PATCH_BulkProcess
            , ('bulkId') : GlobalVariable.PATCH_BulkID, ('URL') : GlobalVariable.URL]))
