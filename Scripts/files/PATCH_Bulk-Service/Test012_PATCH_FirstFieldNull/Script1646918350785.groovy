...
fileName = WS.concatenate((([GlobalVariable.FullQualifiedFilePath, 'Test8_Patch_FirstFieldNull.csv']) as String[]))
...
filePath = WS.concatenate((([GlobalVariable.Data_Files, 'Test8_Patch_FirstFieldNull.csv']) as String[]))
