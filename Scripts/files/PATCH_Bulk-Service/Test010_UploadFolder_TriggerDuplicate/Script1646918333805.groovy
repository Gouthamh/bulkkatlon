...
output = WS.sendRequestAndVerify(findTestObject('FileUpload', [('path') : filePath, ('bulkProcessName') : GlobalVariable.PATCH_BulkProcess
...
output2 = WS.sendRequestAndVerify(findTestObject('FileUpload', [('path') : filePath, ('bulkProcessName') : GlobalVariable.PATCH_BulkProcess
            , ('bulkId') : GlobalVariable.PATCH_BulkID, ('URL') : GlobalVariable.URL]))
