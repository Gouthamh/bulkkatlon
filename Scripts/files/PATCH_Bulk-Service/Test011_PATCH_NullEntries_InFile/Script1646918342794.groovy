...
fileName = WS.concatenate((([GlobalVariable.FullQualifiedFilePath, 'Test7_Patch_NullEntries_InFile.csv']) as String[]))
...
filePath = WS.concatenate((([GlobalVariable.Data_Files, 'Test7_Patch_NullEntries_InFile.csv']) as String[]))
