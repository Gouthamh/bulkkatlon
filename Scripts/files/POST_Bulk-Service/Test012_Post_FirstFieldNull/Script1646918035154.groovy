...
fileName = WS.concatenate((([GlobalVariable.FullQualifiedFilePath, 'Test8_Post_FirstFieldNull.csv']) as String[]))
...
filePath = WS.concatenate((([GlobalVariable.Data_Files, 'Test8_Post_FirstFieldNull.csv']) as String[]))
