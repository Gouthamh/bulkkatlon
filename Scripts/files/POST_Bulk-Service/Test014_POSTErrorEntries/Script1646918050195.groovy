...
fileName = WS.concatenate((([GlobalVariable.FullQualifiedFilePath, 'Test10_POSTErrorEntries.csv']) as String[]))
...
filePath = WS.concatenate((([GlobalVariable.Data_Files, 'Test10_POSTErrorEntries.csv']) as String[]))
...
WS.verifyEqual(countEntries, countEntries2 - 3)
