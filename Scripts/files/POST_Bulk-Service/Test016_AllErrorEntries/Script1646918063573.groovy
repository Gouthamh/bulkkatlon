...
fileName = WS.concatenate((([GlobalVariable.FullQualifiedFilePath, 'Test12_AllErrorEntries.csv']) as String[]))
...
filePath = WS.concatenate((([GlobalVariable.Data_Files, 'Test12_AllErrorEntries.csv']) as String[]))
