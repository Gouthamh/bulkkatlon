...
WS.sendRequestAndVerify(findTestObject('FileUpload', [('path') : GlobalVariable.POST_localFilePath, ('bulkProcessName') : GlobalVariable.POST_bulkProcess]))
WS.sendRequestAndVerify(findTestObject('TriggerBulkAPI', [('bulkProcessName') : GlobalVariable.POST_bulkProcess]))
...
count2 = CustomKeywords.'mongoDatabaseOperations.MongoConnect.countDBEntries'(GlobalVariable.Mongo_URL, GlobalVariable.MongoDBName, 'BULK_DATA_FILE_INFO')
