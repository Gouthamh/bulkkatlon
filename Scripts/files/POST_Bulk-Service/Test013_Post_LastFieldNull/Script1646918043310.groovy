...
fileName = WS.concatenate((([GlobalVariable.FullQualifiedFilePath, 'Test9_Post_LastFieldNull.csv']) as String[]))
...
filePath = WS.concatenate((([GlobalVariable.Data_Files, 'Test9_Post_LastFieldNull.csv']) as String[]))
