...
output = WS.sendRequestAndVerify(findTestObject('processSequential_HazelCast', [('notificationId') : GlobalVariable.Notification_Id
            , ('emailTo') : 'divya.basetti@tecnotree.com', ('msisdn') : '1234567890', ('shortCode') : 8001, ('systemId') : 'smppclient1'
            , ('URL') : GlobalVariable.URL]))

WS.verifyElementPropertyValue(output, 'mqsequentialId', '1234567890')
