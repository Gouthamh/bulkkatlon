...
fileext = CustomKeywords.'sftp_keyword.refactor_sftp.SFTPFileExtensionValidator'(GlobalVariable.Sftp_inform[0], GlobalVariable.Sftp_inform[
	1], GlobalVariable.Sftp_inform[2], GlobalVariable.cache_post_service_host, GlobalVariable.Sftp_inform[3], '/bulk-store/SuccessFileTransfer/','.csv')
...
WS.callTestCase(findTestCase('Action_Type_File/mysql/emailattachements/SFTP_True/0003_Mysql_limit-3'), [:], FailureHandling.STOP_ON_FAILURE)
