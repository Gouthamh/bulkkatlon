...
response=WS.sendRequestAndVerify(findTestObject('bulk_master_api/Mysql/emailattach-2', [('URL') : GlobalVariable.URL, ('ServiceName') : GlobalVariable.POST_bulkProcess
            ...
            , ('Limit') : 3, ('FileExtension') : GlobalVariable.FileExtension[0], ('FieldSeparator') : GlobalVariable.FieldSeparator[0]]))
...
WS.verifyEqual(IMongoDBCount, FMongoDBCount - filecount)
