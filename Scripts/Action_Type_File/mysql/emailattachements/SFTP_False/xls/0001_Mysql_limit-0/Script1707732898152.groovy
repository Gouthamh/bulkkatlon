...
responseupdate = WS.sendRequest(findTestObject('bulk_master_api/Mysql/emailattach-1', [('URL') : GlobalVariable.URL, ('ServiceName') : GlobalVariable.POST_bulkProcess
            ...
            , ('FileExtension') : '.xls', ('FieldSeparator') : '|', ('StopLimit') : GlobalVariable.offsetiszero, ('OffsetEnable') : GlobalVariable.Offset_false
            , ('Limit') : 0]))
...
WS.verifyEqual(ISFTPCount, finalCountProceesed - filecount)
