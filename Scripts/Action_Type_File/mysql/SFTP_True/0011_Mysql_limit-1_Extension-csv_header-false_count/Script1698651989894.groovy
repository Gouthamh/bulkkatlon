...
response = WS.sendRequest(findTestObject('bulk_master_api/Mysql/MYSQL_Actiontyep_file - sftp_true', [('ServiceName') : 'cache-post-bulk-service'
            ...
            , ('IsHeaderEnable') : false, ('SftpEnable') : true, ('CompressEnable') : false, ('Limit') : '1', ('FileExtension') : '.csv'
            , ('FieldSeparator') : '|']))
...
thirdpartycountmysql = CustomKeywords.'mySQL.mySqlFunction.CountTableEntries'(GlobalVariable.MySqlURI, GlobalVariable.MySqlUserName, GlobalVariable.MySqlPassword, 'smdb.BulkNotificationServices')
