...
//
//response = WS.sendRequest(findTestObject('bulk_master_api/Mysql/MYSQL_Actiontyep_file', [('ServiceName') : 'cache-post-bulk-service'
...
WebUI.callTestCase(findTestCase('Action_Type_File/Oracel/SFTP_False/0004_Mysql_limit-0_Extension-csv'), [:], FailureHandling.STOP_ON_FAILURE)
