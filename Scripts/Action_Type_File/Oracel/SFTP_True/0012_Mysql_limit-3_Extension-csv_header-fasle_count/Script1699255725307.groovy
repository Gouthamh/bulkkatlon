...
response=WS.sendRequest(findTestObject('bulk_master_api/oracle/actiontype_file', [('ServiceName') : GlobalVariable.GroupID_BulkProcess, ('BulkID') : GlobalVariable.GroupID_BulkID
	...
	, ('CompressEnable') : false, ('Limit') : '3', ('FileExtension') : '.csv', ('FieldSeparator') : '|'
...
countmysql = CustomKeywords.'mySQL.mySqlFunction.CountTableEntries'(GlobalVariable.MySqlURI, GlobalVariable.MySqlUserName, GlobalVariable.MySqlPassword, 'smdb.BulkNotificationServices')
...
thirdpartysftprecordcount = CustomKeywords.'sftp_keyword.refactor_sftp.SftpAllFileCount'(GlobalVariable.Sftp_inform[0], GlobalVariable.Sftp_inform[
	1], GlobalVariable.Sftp_inform[2], GlobalVariable.cache_sync_bulk_service_host, GlobalVariable.Sftp_inform[3], '/bulk-store/')

println(thirdpartysftprecordcount)

thirdpartycountmysql = 10
