...
thirdpartyInitalCountProceesed = CustomKeywords.'sftp_keyword.refactor_sftp.countFiles'(GlobalVariable.Sftp_inform[0], GlobalVariable.Sftp_inform[
	1], GlobalVariable.Sftp_inform[2], GlobalVariable.cache_sync_bulk_service_host, GlobalVariable.Sftp_inform[3], '/bulk-store/')
//
...
//WebUI.callTestCase(findTestCase('Action_Type_File/Oracel/SFTP_True/0002_Mysql_limit-1'), [:], FailureHandling.STOP_ON_FAILURE)
...
fileext = CustomKeywords.'sftp_keyword.refactor_sftp.SFTPFileExtensionValidator'(GlobalVariable.Sftp_inform[0], GlobalVariable.Sftp_inform[
    1], GlobalVariable.Sftp_inform[2], GlobalVariable.group_id_test_host, GlobalVariable.Sftp_inform[3], '/bulk-store/SuccessFileTransfer/', 
    '.csv')
...
WS.verifyEqual(thirdpartyInitalCountProceesed, thirdpartyfinalCountProceesed)


thirdpartyfileext = CustomKeywords.'sftp_keyword.refactor_sftp.SFTPFileExtensionValidator'(GlobalVariable.Sftp_inform[0], 
    GlobalVariable.Sftp_inform[1], GlobalVariable.Sftp_inform[2], GlobalVariable.cache_sync_bulk_service_host, GlobalVariable.Sftp_inform[
    3], '/bulk-store/', '.csv')
