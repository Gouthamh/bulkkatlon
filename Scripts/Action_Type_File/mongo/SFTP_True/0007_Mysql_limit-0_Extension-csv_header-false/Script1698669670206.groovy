...
WS.comment('count our voulme')
thirdpartyInitalCountProceesed = InitalCountProceesed = CustomKeywords.'sftp_keyword.refactor_sftp.countFiles'(GlobalVariable.Sftp_inform[0], GlobalVariable.Sftp_inform[
	1], GlobalVariable.Sftp_inform[2], GlobalVariable.cache_sync_bulk_service_host, GlobalVariable.Sftp_inform[3], '/bulk-store/')
...
response = WS.sendRequest(findTestObject('bulk_master_api/mongoDB/Action_type-mongo', [('ServiceName') : GlobalVariable.Sync_BulkProcess, ('BulkID') : GlobalVariable.Sync_BulkID
	, ('OffsetEnable') : false, ('StopLimit') : '0', ('RetryEnable') : false, ('IsHeaderEnable') : false, ('SftpEnable') : false
...
filecount = CustomKeywords.'basicOperations.RandomStringGenerator.filecount'(5, 0)
...
thirdpartyfilecount = CustomKeywords.'basicOperations.RandomStringGenerator.filecount'(5, 0)
...
thirdpartyfileext = CustomKeywords.'sftp_keyword.refactor_sftp.SFTPFileExtensionValidator'(GlobalVariable.Sftp_inform[0], GlobalVariable.Sftp_inform[
	1], GlobalVariable.Sftp_inform[2], GlobalVariable.cache_sync_bulk_service_host, GlobalVariable.Sftp_inform[3], '/bulk-store/','.csv')
