...
WS.sendRequest(findTestObject('TriggerBulkAPIWithJsonEmpty', [('bulkProcessName') : GlobalVariable.oracel_update_value[0], ('URL') : GlobalVariable.URL]))
