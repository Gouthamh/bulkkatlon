...
response = WS.sendRequest(findTestObject('bulk_master_api/oracle/create_oracel', [('ServiceName') : GlobalVariable.oracel_create_service_name
            , ('BulkID') : GlobalVariable.oracel_create_id, ('StopLimit') : GlobalVariable.offsetisabovelimit, ('uri') : GlobalVariable.URL
...
WS.verifyElementPropertyValue(response1, GlobalVariable.create_oracel_index[7], GlobalVariable.offsetisabovelimit)
