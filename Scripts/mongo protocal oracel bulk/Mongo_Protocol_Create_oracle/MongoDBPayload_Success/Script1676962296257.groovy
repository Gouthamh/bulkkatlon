...
countEntries = CustomKeywords.'mongoDatabaseOperations.MongoConnect.countDBEntries'(GlobalVariable.Mongo_URL, GlobalVariable.MongoDBName, 
    'DAP_BULK_MONGO_PROTOCOL_OPERATIONS_ORACLE')

WS.sendRequestAndVerify(findTestObject('mongo_protocol_create_oracle', [('URL') : GlobalVariable.URL, ('bulkProcessName') : GlobalVariable.Oracle_create]))
...
WS.verifyEqual(countEntries, countEntries2 - 0)
