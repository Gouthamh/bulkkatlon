...
response = WS.sendRequest(findTestObject('bulk_master_api/oracle/delete_oracel', [('ServiceName') : GlobalVariable.delete_oracel_value[
            0], ('BulkID') : GlobalVariable.delete_oracel_value[1], ('StopLimit') : GlobalVariable.stoplimitunderlimit, ('OffsetEnable') : GlobalVariable.Offset_true]))
...
WS.sendRequest(findTestObject('TriggerBulkAPIWithJsonEmpty', [('bulkProcessName') : GlobalVariable.delete_oracel_value[0], ('URL') : GlobalVariable.URL]))
