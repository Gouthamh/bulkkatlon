...
response = WS.sendRequest(findTestObject('bulk_master_api/oracle/delete_oracel', [('ServiceName') : GlobalVariable.delete_oracel_value[
            0], ('BulkID') : GlobalVariable.delete_oracel_value[1], ('StopLimit') : GlobalVariable.offsetiszero, ('OffsetEnable') : GlobalVariable.Offset_true]))
...
WS.verifyElementPropertyValue(response1, GlobalVariable.delete_oracel_index[7], GlobalVariable.offsetiszero)
